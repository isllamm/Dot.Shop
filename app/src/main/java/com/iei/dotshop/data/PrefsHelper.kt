...
import com.iei.dotshop.utils.Constants
...
object PrefsHelper {
    ...
    fun setFirstName(firstName: String) {
        preferences.edit().putString(Constants.FIRST_NAME, firstName).apply()
    }
    ...
    fun setLastName(lastName: String) {
        preferences.edit().putString(Constants.LAST_NAME, lastName).apply()
    }
